...
def parse_opt():
    ...
    parser.add_argument('--save-info', action='store_true', help='save info to info.txt')
    parser.add_argument('--save-result', action='store_true', help='save metrics to metrics.txt')
